...
class EcoCashPayment:
    def __init__(self):
        ...
        self.merchant_id = '20767'
        self.integration_key = '5d424d11-e49c-4012-a288-818054c86b6f'
        self.base_url = 'http://localhost:5000'
        
        # Initialize Paynow in production mode
        self.paynow = Paynow(
            self.merchant_id,
            self.integration_key,
            f"{self.base_url}/payment-complete",  # Return URL
            f"{self.base_url}/payment-callback"   # Result URL
        )
